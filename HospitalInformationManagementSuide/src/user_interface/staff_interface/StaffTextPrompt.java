 ...
 *  class construction.
 */
public class StaffTextPrompt extends JLabel
	implements FocusListener, DocumentListener
{
	...
	public StaffTextPrompt(String text, JTextComponent component)
	{
		this(text, component, Show.ALWAYS);
	}

	public StaffTextPrompt(String text, JTextComponent component, Show show)
	{
