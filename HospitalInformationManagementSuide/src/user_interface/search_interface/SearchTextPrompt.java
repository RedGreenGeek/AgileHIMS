 ...
 *  class construction.
 */
public class SearchTextPrompt extends JLabel
	implements FocusListener, DocumentListener
{
	...
	public SearchTextPrompt(String text, JTextComponent component)
	{
		this(text, component, Show.ALWAYS);
	}

	public SearchTextPrompt(String text, JTextComponent component, Show show)
	{
